...
public abstract class CustomCameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private CustomCameraBridgeViewBase.CvCameraViewListener2 mListener;
    ...
    protected class CvCameraViewListenerAdapter implements CustomCameraBridgeViewBase.CvCameraViewListener2 {
        public CvCameraViewListenerAdapter(CustomCameraBridgeViewBase.CvCameraViewListener oldStypeListener) {
        ...
        private CustomCameraBridgeViewBase.CvCameraViewListener mOldStyleListener;
    };
    ...
    public void setCvCameraViewListener(CustomCameraBridgeViewBase.CvCameraViewListener2 listener) {
        mListener = listener;
    }

    public void setCvCameraViewListener(CustomCameraBridgeViewBase.CvCameraViewListener listener) {
        CustomCameraBridgeViewBase.CvCameraViewListenerAdapter adapter = new CustomCameraBridgeViewBase.CvCameraViewListenerAdapter(listener);
    ...
    {
        mPreviewFormat = format;
        if (mListener instanceof CustomCameraBridgeViewBase.CvCameraViewListenerAdapter) {
            CustomCameraBridgeViewBase.CvCameraViewListenerAdapter adapter = (CustomCameraBridgeViewBase.CvCameraViewListenerAdapter) mListener;
            adapter.setFrameFormat(mPreviewFormat);
        }
    }
...
//     * @param frame - the current frame to be delivered
//     */
//    protected void deliverAndDrawFrame(CustomCameraBridgeViewBase.CvCameraViewFrame frame) {
//        Mat modified;
//
//        if (mListener != null) {
//            modified = mListener.onCameraFrame(frame);
...
//    }
     ...
     */
    protected Size calculateCameraFrameSize(List<?> supportedSizes, CustomCameraBridgeViewBase.ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        int calcWidth = 0;
        int calcHeight = 0;
